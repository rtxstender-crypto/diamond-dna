...
| MLB game logs and single-game standard stats | MLB Stats API `people/{id}/stats?stats=gameLog` by player + season | On demand; current season revalidates every 2 hours, completed seasons every 30 days | Official player/game IDs, date, opponent, home/away, and available batting/pitching stats. Final score, grand slams, and official no-hitter/perfect-game flags remain null until explicitly sourced. |
